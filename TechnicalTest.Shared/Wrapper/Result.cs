namespace TechnicalTest.Shared.Wrapper
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public new static Result<T> Success(string message = default)
        {
            return new Result<T> { Succeeded = true, Messages = message == default ? null : new List<string> { message } };
        }
        ...
        public static Result<T> Success(T data, List<string> messages = default)
        {
